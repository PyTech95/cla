    ...
    return (
        <div data-testid="mobile-book-bar" className="lg:hidden fixed bottom-0 inset-x-0 z-40 px-3 pt-3 pb-safe bg-noir/90 backdrop-blur-xl border-t border-white/10">
            <div className="flex gap-2 max-w-md mx-auto">
                ...
                <a href="#contact" data-testid="mobile-inquire-btn" className="btn-gold rounded-full flex-[1.4] min-h-[48px] flex items-center justify-center gap-2 text-[11px] uppercase tracking-[0.2em]"><Send className="w-4 h-4" /> Inquire</a>
            </div>
        </div>
    );
}
